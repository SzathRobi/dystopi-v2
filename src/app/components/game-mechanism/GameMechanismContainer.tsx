...
const GameMechanismContainer = () => {
  return (
    ...
    >
      <div className="4xl:px-[24%] relative mb-20 px-[10%] lg:pt-[7%] xl:col-span-7 xl:mb-0">
        <Image
        ...
        <h2
          className={`${vanguard.className} 4xl:text-[12rem] mb-10 max-w-[12ch] text-6xl md:text-7xl lg:mb-16 lg:text-9xl`}
        ...
        <p
          className={`${vanguard.className} 4xl:text-6xl mb-8 text-2xl md:text-3xl`}
        >
          DYSEUM
        </p>

        <div className="4xl:max-w-screen-lg 4xl:text-3xl flex max-w-screen-sm flex-col items-start justify-between gap-4 pb-48 text-sm md:flex-row md:gap-20 md:text-base">
          <p>
      ...
      <div className="4xl:py-64 flex items-center bg-dystopi-sand px-8 py-8 text-dystopi-black lg:px-12 lg:py-28 xl:col-span-5">
        <div className="4xl:pl-24 mb-8 flex flex-col items-start justify-start xl:min-w-[40vw]">
          <article className="4xl:mb-12 mb-8 border-b-2 border-dystopi-black pb-6">
            <h3
              className={`${vanguard.className} 4xl:mb-12 4xl:text-9xl mb-4 text-4xl md:text-5xl lg:mb-8 lg:text-7xl`}
            >
              SHORT STORY
            </h3>

            <div className="4xl:gap-24 4xl:text-3xl flex flex-col items-start gap-4 text-sm sm:gap-8 md:flex-row md:gap-24 md:text-base xl:gap-2 2xl:gap-4">
              <p className="4xl:max-w-3xl xl:max-w-xs">
          ...
          <article className="4xl:mb-12 mb-8 border-b-2 border-dystopi-black pb-6">
            ...
            <div className="4xl:gap-24 4xl:text-3xl flex flex-col items-start gap-4 text-sm sm:gap-8 md:flex-row md:gap-24 md:text-base xl:gap-2 2xl:gap-4">
              <p className="4xl:max-w-3xl xl:max-w-xs">
                ...
                and a versatile crypto token that provides the Play&Ear noture

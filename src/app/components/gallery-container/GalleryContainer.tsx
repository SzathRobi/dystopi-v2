...
const GalleryContainer = () => {
  return (
    <section className="relative h-screen w-full pb-16 lg:pt-[15vh]">
      <h2
        className={`absolute left-6 top-8 z-20 lg:-top-4 lg:left-[10%] ${vanguard.className} text-shadow 4xl:text-[12rem] text-6xl text-dystopi-black md:text-7xl lg:text-9xl`}
      >
        GALLERY
      </h2>
      <Swiper

...
const DecorCircle = () => (
  <div className="4xl:-translate-y-[40%] absolute left-1/2 top-1/2 -z-10 -translate-x-[47%] -translate-y-1/2 -rotate-[110deg] transform md:-translate-x-[58%] lg:-translate-x-[47%] xl:rotate-0">
    <svg
      className="4xl:h-[1024px] 4xl:w-[1024px] h-[320] w-[320px] md:h-[560px] md:w-[560px] lg:h-[380px] lg:w-[380px] xl:h-[380px] xl:w-[380px] 3xl:h-[560px] 3xl:w-[560px]"
      // width="403"
      // height="412"
      viewBox="0 0 403 412"
      fill="none"
...
const NftCharacter = ({ className }: NftCharacterProps) => (
  <div
    className={`4xl:right-24 4xl:min-w-[1024px] relative mb-40 flex flex-col items-center justify-center md:mb-64 xl:-top-16 xl:right-0 xl:mb-0 xl:min-w-[256px] ${className}`}
  >
    <div className="absolute -top-4 left-4 right-auto flex flex-col items-start justify-start xl:-right-24 xl:left-auto xl:top-24">
    ...
    <Image
      ...
      // width={512}
      // height={869}
      className="4xl:max-w-5xl lg:max-w-md xl:max-w-md 2xl:max-w-xl"
    />
    <Image
      ...
      width={880}
      height={939}
      className="4xl:max-w-[880px] :max-w-sm absolute right-1/2 top-3/4 -translate-y-1/4 translate-x-1/2 transform md:translate-x-1/3 lg:max-w-[480px] lg:translate-x-[50%] xl:right-full xl:top-1/2 xl:max-w-[340px] xl:translate-x-36 2xl:max-w-lg 3xl:translate-x-12"
    />
    <p
      className={`${vanguard.className} absolute bottom-auto right-0 top-0 text-3xl font-bold md:right-12 lg:text-5xl xl:-right-24 xl:bottom-24 xl:top-auto`}
    >
      ATLANTEAN
    </p>
  </div>
...
const NftContainer = () => {
  return (
    <section className="4xl:pl-[11%] relative px-[10%] py-36">
      <Image
      ...
      <div className="flex flex-col items-start justify-start lg:flex-row">
        <div>
          <h2
            className={`${vanguard.className} 4xl:max-w-none 4xl:text-9xl mb-12 text-3xl font-semibold md:mb-36 md:text-6xl lg:mb-48 lg:text-5xl xl:max-w-[30ch] 2xl:text-7xl`}
          >
          ...
          <div className="flex flex-col-reverse items-start justify-start lg:flex-row">
            <div className="4xl:text-3xl">
              <p className="4xl:max-w-3xl mb-16 max-w-md lg:mb-20">
              ...
              <p className="4xl:max-w-3xl max-w-md">

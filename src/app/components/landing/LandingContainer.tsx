  ...
  return (
    <section className="flex min-h-screen w-full flex-col items-center justify-center lg:justify-end">
      <Image
        ...
        fill
        className="relative -z-10 object-cover brightness-95"
        priority
      />
      <div className="flex -translate-y-16 transform flex-col items-center justify-center p-6 lg:-translate-y-32 xl:-translate-y-56 4xl:absolute 4xl:left-1/2 4xl:top-1/2 4xl:-translate-x-1/2 4xl:-translate-y-1/2">
        <h1
          className={`${karla.className} text-7xl font-semibold md:text-[140px] lg:text-[180px] xl:text-[200px] xl:leading-[220px] 4xl:leading-[520px] 4xl:text-[480x]`}
        >
          DYSTOPI
        </h1>
        <div className="flex items-center justify-center gap-1 text-[0.5rem] md:text-sm lg:mb-8 lg:gap-2 lg:text-base 4xl:text-3xl">
          <FaStarOfLife />
        ...
        >
          <span className="relative top-1  font-mono text-3xl md:text-4xl lg:top-3 lg:text-7xl 2xl:text-9xl">
            $
          </span>
          <span>500 000</span>
          <span>AIRDROP</span>
